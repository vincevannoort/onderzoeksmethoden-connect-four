...
class Model:
  ...
  def train(self, tensorboard, train_data:list, test_data:list, epochs:int):
    self.model.fit(train_data, test_data, verbose=1, epochs=epochs, callbacks=[tensorboard], validation_split=0.1, batch_size=128)
...
if __name__ == "__main__":
  ...
  model.train(tensorboard, train_data, test_data, 100)
  model.save()
