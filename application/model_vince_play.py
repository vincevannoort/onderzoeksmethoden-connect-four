...
model_minimax = keras.models.load_model(f"../models/trained_with_random/model_vince_35000_moves.h5")
model_random = keras.models.load_model(f"../models/trained_with_random/model_jort_500000_moves.h5", compile=True)
print("Finished loading model")

first_player = Player("Bot", "B", "random", model_random)
second_player = Player("Opposite", "O", "random", model_random)
